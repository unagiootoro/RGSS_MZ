...
var wasmBinaryFile = 'program2.wasm';
...
var ASM_CONSTS = {
  ...
  function _rgss_file_read(ptrFileName, ptrBuf, ptrBufSize) {
          const fs = require("fs");
  ...
  function _rgss_file_write(ptrFileName, ptrBuf, bufSize) {
          const fs = require("fs");
          const fileName = UTF8ToString(ptrFileName);
          let utf8buf = "";
  ...
  function _rgss_send_message(ptrMessage) {
  ...
  function _rgssenv_bitmap_fill_rect(bitmap_id, x, y, width, height, ptr_color) {
  ...
  function _rgssenv_bitmap_get_height(bitmap_id) {
          const obj = { bitmap_id };
          return SceneManager._scene.doProcess("Bitmap_get_height", obj);
      }

  function _rgssenv_bitmap_get_width(bitmap_id) {
          const obj = { bitmap_id };
          return SceneManager._scene.doProcess("Bitmap_get_width", obj);
      }

  function _rgssenv_bitmap_measure_text_width(bitmap_id, ptr_text) {
          const text = UTF8ToString(ptr_text);
          const obj = { bitmap_id, text };
          return SceneManager._scene.doProcess("Bitmap_measure_text_width", obj);
      }

  function _rgssenv_bitmap_new(ptr_file_name, width, height) {
          let file_name = null;
          if (ptr_file_name !== 0) {
  ...
  function _rgssenv_bitmap_set_font(bitmap_id, ptr_face, size, int_bold, int_italic, ptr_color) {
  ...
  function _rgssenv_tilemap_set_origin(tilemap_id, ox, oy) {
          const obj = { tilemap_id, ox, oy };
          return SceneManager._scene.doProcess("Tilemap_set_origin", obj);
      }

  function _rgssenv_tilemap_set_priorities(tilemap_id, ptr_priorities, priorities_size) {
...
var asmLibraryArg = {
  ...
  "mktime": _mktime,
  "rgss_file_read": _rgss_file_read,
  "rgss_file_write": _rgss_file_write,
  "rgss_send_message": _rgss_send_message,
  "rgssenv_audio_midi_bgm_fade_out": _rgssenv_audio_midi_bgm_fade_out,
  "rgssenv_audio_midi_bgm_play": _rgssenv_audio_midi_bgm_play,
  "rgssenv_audio_midi_bgm_stop": _rgssenv_audio_midi_bgm_stop,
  "rgssenv_audio_midi_me_play": _rgssenv_audio_midi_me_play,
  "rgssenv_audio_ogg_bgm_fade_out": _rgssenv_audio_ogg_bgm_fade_out,
  "rgssenv_audio_ogg_bgm_play": _rgssenv_audio_ogg_bgm_play,
  "rgssenv_audio_ogg_bgm_stop": _rgssenv_audio_ogg_bgm_stop,
  "rgssenv_audio_ogg_bgs_fade_out": _rgssenv_audio_ogg_bgs_fade_out,
  "rgssenv_audio_ogg_bgs_play": _rgssenv_audio_ogg_bgs_play,
  "rgssenv_audio_ogg_bgs_stop": _rgssenv_audio_ogg_bgs_stop,
  "rgssenv_audio_ogg_me_fade_out": _rgssenv_audio_ogg_me_fade_out,
  "rgssenv_audio_ogg_me_play": _rgssenv_audio_ogg_me_play,
  "rgssenv_audio_ogg_se_fade_out": _rgssenv_audio_ogg_se_fade_out,
  "rgssenv_audio_ogg_se_play": _rgssenv_audio_ogg_se_play,
  "rgssenv_bitmap_blt": _rgssenv_bitmap_blt,
  "rgssenv_bitmap_check_created": _rgssenv_bitmap_check_created,
  "rgssenv_bitmap_clear": _rgssenv_bitmap_clear,
  "rgssenv_bitmap_delete": _rgssenv_bitmap_delete,
  "rgssenv_bitmap_draw_text": _rgssenv_bitmap_draw_text,
  "rgssenv_bitmap_fill_rect": _rgssenv_bitmap_fill_rect,
  "rgssenv_bitmap_get_height": _rgssenv_bitmap_get_height,
  "rgssenv_bitmap_get_width": _rgssenv_bitmap_get_width,
  "rgssenv_bitmap_measure_text_width": _rgssenv_bitmap_measure_text_width,
  "rgssenv_bitmap_new": _rgssenv_bitmap_new,
  "rgssenv_bitmap_set_font": _rgssenv_bitmap_set_font,
  "rgssenv_input_dir4": _rgssenv_input_dir4,
  "rgssenv_input_dir8": _rgssenv_input_dir8,
  "rgssenv_input_is_pressed": _rgssenv_input_is_pressed,
  "rgssenv_input_is_repeated": _rgssenv_input_is_repeated,
  "rgssenv_input_is_triggered": _rgssenv_input_is_triggered,
  "rgssenv_sprite_delete": _rgssenv_sprite_delete,
  "rgssenv_sprite_new": _rgssenv_sprite_new,
  "rgssenv_sprite_set_bitmap": _rgssenv_sprite_set_bitmap,
  "rgssenv_sprite_set_frame": _rgssenv_sprite_set_frame,
  "rgssenv_sprite_set_opacity": _rgssenv_sprite_set_opacity,
  "rgssenv_sprite_set_visible": _rgssenv_sprite_set_visible,
  "rgssenv_sprite_set_x": _rgssenv_sprite_set_x,
  "rgssenv_sprite_set_y": _rgssenv_sprite_set_y,
  "rgssenv_sprite_set_z": _rgssenv_sprite_set_z,
  "rgssenv_sprite_update": _rgssenv_sprite_update,
  "rgssenv_tilemap_delete": _rgssenv_tilemap_delete,
  "rgssenv_tilemap_new": _rgssenv_tilemap_new,
  "rgssenv_tilemap_set_autotile": _rgssenv_tilemap_set_autotile,
  "rgssenv_tilemap_set_map_data": _rgssenv_tilemap_set_map_data,
  "rgssenv_tilemap_set_origin": _rgssenv_tilemap_set_origin,
  "rgssenv_tilemap_set_priorities": _rgssenv_tilemap_set_priorities,
  "rgssenv_tilemap_set_tileset": _rgssenv_tilemap_set_tileset,
  "rgssenv_tilemap_update": _rgssenv_tilemap_update,
  "rgssenv_viewport_delete": _rgssenv_viewport_delete,
  "rgssenv_viewport_new": _rgssenv_viewport_new,
  "rgssenv_viewport_set_z": _rgssenv_viewport_set_z,
  "rgssenv_viewport_update": _rgssenv_viewport_update,
  "rgssenv_window_delete": _rgssenv_window_delete,
  "rgssenv_window_get_bitmap": _rgssenv_window_get_bitmap,
  "rgssenv_window_new": _rgssenv_window_new,
  "rgssenv_window_set_bitmap": _rgssenv_window_set_bitmap,
  "rgssenv_window_set_contents_opacity": _rgssenv_window_set_contents_opacity,
  "rgssenv_window_set_cursor_rect": _rgssenv_window_set_cursor_rect,
  "rgssenv_window_set_height": _rgssenv_window_set_height,
  "rgssenv_window_set_opacity": _rgssenv_window_set_opacity,
  "rgssenv_window_set_visible": _rgssenv_window_set_visible,
  "rgssenv_window_set_width": _rgssenv_window_set_width,
  "rgssenv_window_set_x": _rgssenv_window_set_x,
  "rgssenv_window_set_y": _rgssenv_window_set_y,
  "rgssenv_window_set_z": _rgssenv_window_set_z,
  "rgssenv_window_update": _rgssenv_window_update,
...
/** @type {function(...*):?} */
var _init_rgss = Module["_init_rgss"] = createExportWrapper("init_rgss");

/** @type {function(...*):?} */
var _malloc = Module["_malloc"] = createExportWrapper("malloc");

/** @type {function(...*):?} */
var _update_rgss = Module["_update_rgss"] = createExportWrapper("update_rgss");
